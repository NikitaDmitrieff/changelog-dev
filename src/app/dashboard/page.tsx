    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        {!isPro && process.env.STRIPE_SECRET_KEY && (
          <div className="mb-6 bg-white/5 border border-white/10 rounded-xl px-5 py-4 flex items-center justify-between">
            <div>
              <div className="text-sm font-medium">Free plan — 1 changelog, 100 subscribers</div>
              <div className="text-xs text-white/40 mt-0.5">Upgrade to Pro for unlimited everything</div>
            </div>
            <UpgradeButton />
          </div>
        )}
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          {atFreeLimit ? (
            <div className="flex items-center gap-3">
              <span className="text-xs text-white/30">Free plan: 1 changelog max</span>
              <UpgradeButton small />
            </div>
          ) : (
            <Link
