  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <nav className={`sticky top-0 z-50 border-b border-white/[0.06] backdrop-blur-md bg-black/60 transition-all duration-200 ${scrolled ? 'py-2.5' : 'py-4'} px-6`}>
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            ...
            >
              <div className="max-w-5xl mx-auto flex flex-col gap-4 pt-4 pb-2">
                <Link href="/blog" className="text-sm text-zinc-400 hover:text-white transition-colors" onClick={() => setMobileMenuOpen(false)}>
                  Blog
                </Link>
                <Link href="/demo" className="text-sm text-zinc-400 hover:text-white transition-colors" onClick={() => setMobileMenuOpen(false)}>
                  Demo
                </Link>
                <Link href="/docs/api" className="text-sm text-zinc-400 hover:text-white transition-colors" onClick={() => setMobileMenuOpen(false)}>
                  Docs
                </Link>
                <Link href="/login" className="text-sm text-zinc-400 hover:text-white transition-colors" onClick={() => setMobileMenuOpen(false)}>
                  Sign in
                </Link>
                <Link
                  href="/login"
                  className="bg-indigo-500 hover:bg-indigo-400 text-white text-sm font-medium px-4 py-2.5 rounded-lg transition-colors text-center"
      ...
      <section className="px-6 py-20 border-t border-white/[0.06]">
        <div className="max-w-4xl mx-auto">
          <FadeIn className="text-center mb-14">
            <span className="text-xs font-semibold text-indigo-400 uppercase tracking-widest font-mono">Open source</span>
            <h2 className="mt-3 text-3xl font-bold text-white">Embeddable widget for any site</h2>
            <p className="mt-2 text-zinc-500 text-sm max-w-lg mx-auto">
              Drop a single script tag into your app. Your users see a bell icon — click it to read what&apos;s new. Zero dependencies, works everywhere.
            </p>
          </FadeIn>
            ...
            <FadeIn delay={0.1}>
              <div className="glass-card rounded-xl p-6 h-full">
                ...
                <div className="rounded-md border border-white/[0.06] bg-zinc-950 p-4 font-mono text-[13px] leading-relaxed">
                  <div className="text-zinc-600 mb-1">&lt;!-- Add to any HTML page --&gt;</div>
                ...
                <ul className="mt-4 space-y-2 text-sm text-zinc-500">
                  <li className="flex items-center gap-2"><span className="text-indigo-400">+</span> Shadow DOM — styles never leak</li>
                  <li className="flex items-center gap-2"><span className="text-indigo-400">+</span> Dark / light / auto themes</li>
                  <li className="flex items-center gap-2"><span className="text-indigo-400">+</span> Unread badge with localStorage</li>
                  <li className="flex items-center gap-2"><span className="text-indigo-400">+</span> Under 8KB gzipped</li>
                </ul>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.2}>
              <div className="glass-card rounded-xl p-6 h-full">
                ...
                <div className="rounded-md border border-white/[0.06] bg-zinc-950 p-4 font-mono text-[13px] leading-relaxed">
                  ...
                  <div className="mt-2 text-zinc-600">// In your app</div>
                  <div className="text-indigo-400">import &apos;changelogdev-widget&apos;</div>
                  <div className="mt-1 text-emerald-400">&lt;changelog-widget project-id=&quot;my-app&quot; theme=&quot;dark&quot; /&gt;</div>
                </div>
                <p className="mt-4 text-sm text-zinc-500 leading-relaxed">
                  Works with React, Vue, Svelte, Angular, or vanilla JS. Web Components run everywhere.
                </p>
          ...
          <FadeIn delay={0.3} className="text-center mt-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 border border-white/[0.12] hover:border-white/[0.25] bg-white/[0.03] hover:bg-white/[0.06] text-zinc-300 hover:text-white font-medium px-6 py-3 rounded-xl transition-all text-sm"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
              </svg>
              Get the free widget on GitHub
            </a>
          </FadeIn>
        </div>
      </section>
